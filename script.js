document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_TARGETS = '.animate-on-scroll, .feature-card, .section-title, .hero-content';

  const animatedElements = document.querySelectorAll(ANIMATION_TARGETS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '48f1f531-a9f6-40ff-9430-bfaec8c16c38',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '48f1f531-a9f6-40ff-9430-bfaec8c16c38';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '48f1f531-a9f6-40ff-9430-bfaec8c16c38';
